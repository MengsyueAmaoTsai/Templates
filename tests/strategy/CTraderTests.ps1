...
dotnet build ./MyCTraderSignalSource/MyCTraderSignalSource.csproj -c Release
dotnet publish ./MyCTraderSignalSource/MyCTraderSignalSource.csproj -c Release /p:AlgoBuild=true /p:AlgoPublish=true
